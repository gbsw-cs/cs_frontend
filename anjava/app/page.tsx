  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-white px-6">
      <div className="flex flex-1 flex-col items-center justify-center pt-24">
        <Image src="/logo.png" alt="안자봐" width={220} height={90} priority />
        <p className="mt-6 text-[15px] text-zinc-800">
          <span className="font-semibold text-[#2563EB]">개발자</span>를 위한 무의식{" "}
          <span className="font-semibold text-[#2563EB]">자세 교정</span> 서비스
        </p>
      </div>
      <div className="mb-28 flex w-full max-w-[320px] flex-col gap-3">
        <Link
          href="/login"
