        ...
        <div className="grid min-h-0 flex-1 grid-cols-12 gap-2 overflow-visible lg:grid-rows-[minmax(176px,0.82fr)_minmax(156px,0.68fr)_minmax(236px,1.2fr)] lg:gap-x-2 lg:gap-y-2 lg:overflow-visible">
          ...
          <Card className="col-span-12 flex min-h-0 flex-col overflow-hidden sm:col-span-6 lg:col-span-2">
            <div className="-mt-4 flex min-h-0 flex-col items-center">
              ...
              <div className="mt-1 w-full shrink-0 rounded-lg px-2 py-1 text-center ring-1 ring-zinc-100">
                <div className="text-[8px] font-semibold leading-none text-zinc-400">실시간 감지 상태</div>
                <div className={`mt-0.5 flex min-h-[23px] items-center justify-center text-[12px] font-bold leading-tight ${
                  liveIsGood
                    ? "text-emerald-500"
                    : liveIsBad
                    ? "text-rose-500"
